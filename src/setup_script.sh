...
apt-get update
apt-get install -y --no-install-recommends openbox xorg libnvidia-gl-535-server dbus-x11 gnome-icon-theme libcanberra-gtk-module libcanberra-gtk3-module libgl1-mesa-dri libgl1-mesa-glx libnotify-bin rtkit xserver-xorg-video-nvidia-550-server
